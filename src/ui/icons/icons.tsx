...
/**
 * Icons exported from the Figma design system.
 *
 * The `d` attributes are the exact path data from the design's own SVG exports —
 * `src/ui/icons/assets/` holds those exports verbatim for comparison. Two things
 * change on the way in, both deliberate:
 *
 * - the baked `fill` becomes `currentColor`, so colour comes from the token
 *   layer instead of being frozen at export time. The design ships the same
 *   alarm glyph twice, once white and once red, purely because a fill cannot be
 *   overridden; here that is one icon and a text colour.
 * - the artboard is normalised to a square `viewBox` matching the size the
 *   design draws the icon at, so a caller sets one dimension and the glyph keeps
 *   its aspect ratio and padding.
 *
 * Sizing is the caller's job via `className`. Each icon below documents the box
 * the design places it in.
 */
...
/** 24x24 box. The clock on the due-date badge. */
export function AlarmIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 20.506 19.253" fill="none" aria-hidden="true" {...props}>
      <path
        d="M10.253 19.253C9.0711 19.253 7.90078 19.0202 6.80885 18.5679C5.71692 18.1156 4.72477 17.4527 3.88904 16.617C3.05331 15.7812 2.39038 14.7891 1.93808 13.6972C1.48579 12.6052 1.253 11.4349 1.253 10.253C1.253 9.0711 1.48579 7.90078 1.93808 6.80885C2.39038 5.71692 3.05331 4.72477 3.88904 3.88904C4.72477 3.05331 5.71692 2.39038 6.80885 1.93808C7.90078 1.48579 9.0711 1.253 10.253 1.253C12.6399 1.253 14.9291 2.20121 16.617 3.88904C18.3048 5.57687 19.253 7.86605 19.253 10.253C19.253 12.6399 18.3048 14.9291 16.617 16.617C14.9291 18.3048 12.6399 19.253 10.253 19.253ZM10.253 17.253C11.1723 17.253 12.0825 17.0719 12.9318 16.7202C13.7811 16.3684 14.5527 15.8528 15.2027 15.2027C15.8528 14.5527 16.3684 13.7811 16.7202 12.9318C17.0719 12.0825 17.253 11.1723 17.253 10.253C17.253 9.33375 17.0719 8.42349 16.7202 7.57422C16.3684 6.72494 15.8528 5.95326 15.2027 5.30325C14.5527 4.65324 13.7811 4.13763 12.9318 3.78584C12.0825 3.43406 11.1723 3.253 10.253 3.253C8.39648 3.253 6.61601 3.9905 5.30325 5.30325C3.9905 6.61601 3.253 8.39648 3.253 10.253C3.253 12.1095 3.9905 13.89 5.30325 15.2027C6.61601 16.5155 8.39648 17.253 10.253 17.253ZM11.253 10.253H14.253V12.253H9.253V5.253H11.253V10.253ZM0 3.535L3.535 0L4.95 1.414L1.413 4.95L0 3.535ZM16.97 0L20.506 3.535L19.092 4.95L15.556 1.414L16.971 0H16.97Z"
        fill="currentColor"
      />
    </svg>
  )
...
/** 16x16 box. Second counter on a task card's footer. */
export function SubtaskIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 12 13.3333" fill="none" aria-hidden="true" {...props}>
      <path
...
/** 16x16 box. Third counter on a task card's footer. */
export function CommentIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 13.3333 13.3333" fill="none" aria-hidden="true" {...props}>
      <path
        d="M3.52734 12.5493L0 13.3333L0.784008 9.806C0.267695 8.84025 -0.00164123 7.76176 0 6.66667C0 2.98467 2.98467 0 6.66667 0C10.3487 0 13.3333 2.98467 13.3333 6.66667C13.3333 10.3487 10.3487 13.3333 6.66667 13.3333C5.57158 13.335 4.49309 13.0656 3.52734 12.5493ZM3.72067 11.1407L4.15601 11.374C4.92837 11.7868 5.79094 12.0018 6.66667 12C7.72151 12 8.75265 11.6872 9.62971 11.1012C10.5068 10.5151 11.1904 9.68218 11.594 8.70764C11.9977 7.73311 12.1033 6.66075 11.8975 5.62618C11.6917 4.59162 11.1838 3.64131 10.4379 2.89543C9.69203 2.14955 8.74172 1.6416 7.70716 1.43581C6.67259 1.23002 5.60024 1.33564 4.6257 1.73931C3.65116 2.14298 2.8182 2.82656 2.23217 3.70363C1.64614 4.58069 1.33334 5.61183 1.33334 6.66667C1.33334 7.556 1.55001 8.412 1.96001 9.17733L2.19267 9.61267L1.75601 11.5773L3.72067 11.1407Z"
        fill="currentColor"
      />
    </svg>
  )
...
/** 24x24 box. Sidebar "dashboard" tab, and the grid option in the view switcher. */
...
/** 24x24 box. Sidebar "my task" tab, and the list option in the view switcher. */
export function ListViewIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 18 16" fill="none" aria-hidden="true" {...props}>
      <path d="M0 0H18V2H0V0ZM0 7H18V9H0V7ZM0 14H18V16H0V14Z" fill="currentColor" />
    </svg>
  )
}

/** 24x24 box inside the 40x40 create button. */
...
/** 24x24 box at the left of the search bar. */
export function SearchIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 20.314 20.314" fill="none" aria-hidden="true" {...props}>
      <path
...
/** 24x24 box at the right of the search bar. */
export function BellIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 20 21" fill="none" aria-hidden="true" {...props}>
      <path
...
/**
 * The logomark, 40x40 in the design.
 *
 * Figma exports it as two separate vectors positioned by percentage inset. Those
